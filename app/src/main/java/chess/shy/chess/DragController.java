...
public class DragController {
     ...
     */
    public DragController(Chess launcher) {
    ...
    public void startDrag(View v, Bitmap bmp, DragSource source, Object dragInfo, int dragAction,
        ...
        mChess.getDragLayer().getLocationInDragLayer(v, loc);
        ...
        int[] delt = mChess.getDragLayer().getmDelt();
        startDrag(bmp, dragLayerX + (delt[0]/2) - bmp.getWidth()/2, dragLayerY + (delt[1]/2) - bmp.getHeight()/2, source, dragInfo, dragAction, null, dragRegion, initialDragViewScale);
    ...
    public void startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        if (mInputMethodManager == null) {
            mInputMethodManager = (InputMethodManager)
                    mChess.getSystemService(Context.INPUT_METHOD_SERVICE);
        }
        ...
        final DragView dragView = mDragObject.dragView = new DragView(mChess, b, registrationX,
...
//        }
    ...
    private int[] getClampedDragLayerPos(float x, float y) {
        mChess.getDragLayer().getLocalVisibleRect(mDragLayerRect);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (debug) {
            Log.d("1111", "DragController.onInterceptTouchEvent " + ev + " mDragging="
                    + mDragging);
        }
    ...
    private void clearScrollRunnable() {
        ...
        if (mScrollState == SCROLL_WAITING_IN_ZONE) {
            ...
            mChess.getDragLayer().onExitScrollArea();
        }
    }
    ...
    private void handleMoveEvent(int x, int y) {
        ...
        final int slop = ViewConfiguration.get(mChess).getScaledWindowTouchSlop();
        		...
        		if (true) {
        			if (mScrollState == SCROLL_OUTSIDE_ZONE) {
        				...
        				if (mDragScroller.onEnterScrollArea(x, y, SCROLL_LEFT)) {
        					mChess.getDragLayer().onEnterScrollArea(SCROLL_LEFT);
...
//        	if (x > mScrollView.getWidth() - mScrollZone - mChess.getmNewDockBar().getWidth() && x < mScrollView.getWidth() - mChess.getmNewDockBar().getWidth()) {
//        		if (mScrollState == SCROLL_OUTSIDE_ZONE) {
//        			mScrollState = SCROLL_WAITING_IN_ZONE;
//        			if (mDragScroller.onEnterScrollArea(x, y, SCROLL_RIGHT)) {
//        				mChess.getDragLayer().onEnterScrollArea(SCROLL_RIGHT);
//        				mScrollRunnable.setDirection(SCROLL_RIGHT);
//        				mHandler.postDelayed(mScrollRunnable, delay);
//        			}
//        		}
//        	}
    ...
    private PointF isFlingingToDelete(DragSource source) {
        ...
        ViewConfiguration config = ViewConfiguration.get(mChess);
